...
class Snowman:
    ...
    def draw_snowman(self):
        ...
        head_radius = 15
        head = pygame.draw.circle(
            self.image, self.color, (self.rect.width / 2, head_radius), head_radius
        )
        ...
        body = pygame.draw.circle(
            self.image,
            self.color,
            (self.rect.width / 2, head.bottom + body_radius),
            body_radius,
        )

        bottom_radius = 50
        bottom = pygame.draw.circle(
            self.image,
            self.color,
            (self.rect.width / 2, body.bottom + bottom_radius),
            bottom_radius,
        )
